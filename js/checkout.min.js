                ...
                if(cartList[i].id_produto === bd[j].id_produto){
                    ...
                    <div class="media mb-2 border-bottom">
                        <div class="media-body"> <a href="detail.html">${bd[j].nome}</a>
                            <div class="small text-muted">Preço: R$${bd[j].preco.toLocaleString('pt-BR',{minimumFractionDigits:2})} <span class="mx-2">|</span> Qtd:${cartList[i].count} <span class="mx-2">|</span> Subtotal: R$${(bd[j].preco * cartList[i].count).toLocaleString('pt-BR',{minimumFractionDigits:2})}</div>
                        </div>
                    </div>
                    `
